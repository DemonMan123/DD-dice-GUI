Descriptions = {
    ...
    'Dominion Over Darkness' : "The Tarot Holder unleashes dark energy from the Maw, allowing attacks to bypass enemy defenses and inflict [Void Burn]. If the holder is a Bionic, all of their attacks inflict [Void Burn].",
    'Consuming Avatar' : "The Tarot Holder is possessed by a Possessor of the Maw, gaining enhanced strength, speed, and durability.",
    'Maws Sovereignty' : "The Tarot Holder harnesses the power of the Maw, turning the holder into an Evobionic. If the holder is a Bionic, they gain a permanent buff to attacks.",
    'Corrupted Soul' : "The Tarot Holder's soul is corrupted, slowly turning them insane and violent.",
    'Haunted by Shadows' : "The party is being watched by something in the darkness.",
    'Bargain of the Abyss' : "The Tarot Holder is forced to make a pact with a Possessor of the Maw, exchanging their soul for something important to the holder.",
    # High Spire
    'Aerial Advantage' : "The party is given an option in the next encounter to have high ground, granting them tactical superiority and bonuses to attack actions and [Perception] rolls.",
    'Eagles Eye' : "The Tarot Holder finds a drone that aids in spotting enemies or objects.",
    'Tactical Jump' : "The party is given a limited supply of jump-packs, granting them temporary flight. The jump-packs has 5 uses.",
    'Abyssal Fall' : "Bridges, catwalks, and corridors are susceptible to falling if too many people are on it. If a party member falls, they will be automatically captured by enemies.",
    'Storms Wrath' : "The traitors have created new abominations that now fly.",
    'Lonely Heights' : "The Tarot Holder is becomes separated from the party if on a high place.",
    # The Gate
    'Portal of Opportunity' : "The party encounters an Evobionic that allows them to travel to any key location of their choosing.",
    'Guardian of the Gate' : "The Tarot Holder gains favor of an Evobionic who will help to teleport the party out of immediate danger.",
    'Gatekeepers Knowledge' : "The Tarot Holder gains insight on certain Mawic information.",
    'Sealed Fate' : "The Tarot Holder becomes trapped on the wrong side of a Mawic portal. They must find a way out or suffer the approaching dangers.",
    'Gateway to Oblivion' : "The party encounters an abandoned ritual. If the items that were left behind are touched or the sigils drawn on the floors and walls come into contact with blood, a Mawic portal opens for malevolent souls to leak through, dragging anyone that moves into the portal.",
    'Toll of the Gate' : "The Tarot Holder encounters an Evobionic witch that can grant them safe passage through a hazardous area, but at the cost of something great.",
    # Black Moon
    'Shadowy Veil' : "The Tarot Holder is shrouded in Mawic energy that grants them invisibility and [Advantaged Rolls] on stealth actions for a limited time.",
    'Umbral Shield' : "The Tarot Holder is covered in an aura of darkness, granting them resistance to damage.",
    'Umbral Conduit' : "The party is able to have shadows follow them if grouped together, making them silent and unseen by enemies.",
    'Cursed Eclipse' : "The Tarot Holder is cursed by a cult of Black Moon worshippers, suffering damage and hallucinations anytime they are in the dark for too long.",
    'Moons Malice' : "The party attracts a new enemy faction known as the Children of the Black Moon.",
    'Tides of Darkness' : "Enemies are now empowered in the dark.",
    # Solar Beacon
    'Radiant Blessing' : "The Tarot Card pulses 5 cleansing Mawic lights that dispels necrotic powers while also healing allies in [Clarity].",
    'Solar Empowerment' : "The party is granted enhanced speed and endurance while in the light for a limited time.",
    'Beacons Guidance' : "The Tarot Holder gains 5 points to [Charisma].",
    'Blinding Radiance' : "The party is temporarily blinded, losing 2 points to [Wisdom] and suffering penalties to your attacks.",
    'Solar Flare' : "The party suffers [Burning] as they are engulfed by a burst of intense heat, suffering damage over time and being temporarily stunned.",
    'Heat Exhaustion' : "The party's stamina runs out quicker and skills are suffer certain impairments.",
    # Call of the Maw
    'Beckoning Shadows' : "The Tarot Holder conjures shadowy figures from the Maw to aid them in battle. Light immediately disperses them. If the holder is a Bionic, they can conjure the figures an additional time.",
    'Echoes of the Abyss' : "Party members gain a temporary bonus to any Mawic skill.",
    'Maws Favor' : "The Tarot Holder's attacks are imbued with [Void Burn].",
    'Whispers of Madness' : "The Tarot Holder becomes paranoid, only being able to roll [Disadvantaged Rolls] on [Wisdom] actions.",
    'Abyssal Hunger' : "The Tarot Holder is being followed by a Possessor who wants to possess them. In order to get rid of the Possessor, they must either have their soul cleansed by an Evobionic or attempt a heretical ritual.",
    'Voids Embrace' : "The Tarot Holder causes an event that has the party encounter a dormant Possessor of the Maw. The party must stay quiet as possible as not to wake it. If the Possessor awakens, the party must find a way to successfully escape it or defeat it.",
    # Astral Realm
    'Cosmic Insight' : "The Tarot Holder is granted 10 points of [Intelligence] and [Wisdom].",
    'Astral Projection' : "The Tarot Holder can project their consciousness to any area they wish, communicating with those in the area.",
    'Astral Runes' : "The walls are covered in forbidden runes that will damage anyone who looks at them.",
    'Celestial Anguish' : "The party feels something tugging at their souls, damaging them slowly over time temporarily."
}
